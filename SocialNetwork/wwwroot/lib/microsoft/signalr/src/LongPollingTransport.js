            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        this.logger.log(ILogger_1.LogLevel.Trace, "(LongPolling transport) polling: ".concat(pollUrl, "."));
                        return [4 /*yield*/, this.httpClient.get(pollUrl, pollOptions)];
                    case 2:
                        response = _c.sent();
                        if (response.statusCode !== 200) {
                            this.logger.log(ILogger_1.LogLevel.Error, "(LongPolling transport) Unexpected response code: ".concat(response.statusCode, "."));
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (response.statusCode === 204) {
                            ...
                            if (response.content) {
                                this.logger.log(ILogger_1.LogLevel.Trace, "(LongPolling transport) data received. ".concat((0, Utils_1.getDataDetail)(response.content, this.logMessageContent), "."));
                                if (this.onreceive) {
                    ...
                    case 5:
                        ...
                        if (!this.running) {
                            ...
                            this.logger.log(ILogger_1.LogLevel.Trace, "(LongPolling transport) Poll errored after shutdown: ".concat(e_1.message));
                        }
                        else {
    ...
    LongPollingTransport.prototype.send = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, (0, Utils_1.sendMessage)(this.logger, "LongPolling", this.httpClient, this.url, this.accessTokenFactory, data, this.logMessageContent, this.withCredentials, this.headers)];
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        this.logger.log(ILogger_1.LogLevel.Trace, "(LongPolling transport) sending DELETE request to ".concat(this.url, "."));
                        headers = {};
